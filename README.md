...
1. Align your CriticalMaps traces with the map:
   Find a recognizable location on the map that is not too close to the scene's world origin or any of the main axes. Move your 3D cursor there and note its X and Y position as the anchor point. Set the latitude and longitude accordingly.
